...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.isVerified = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _isVerified_initializers, void 0));
            this.provider = (__runInitializers(this, _isVerified_extraInitializers), __runInitializers(this, _provider_initializers, void 0));
            ...
            this.verificationToken = (__runInitializers(this, _providerId_extraInitializers), __runInitializers(this, _verificationToken_initializers, void 0));
            this.verifiedAt = (__runInitializers(this, _verificationToken_extraInitializers), __runInitializers(this, _verifiedAt_initializers, void 0));
    ...
    (() => {
        ...
        _email_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 100, unique: true }), (0, class_validator_1.IsEmail)(), (0, class_validator_1.IsNotEmpty)()];
        _username_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 50, unique: true }), (0, class_validator_1.IsNotEmpty)()];
        _password_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 255 }), (0, class_validator_1.MinLength)(6)];
        _isVerified_decorators = [(0, typeorm_1.Column)({ type: 'boolean', default: false })];
        _provider_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 50, nullable: true })];
        _providerId_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 100, nullable: true })];
        _verificationToken_decorators = [(0, typeorm_1.Column)({ type: 'varchar', length: 100, nullable: true })];
