...
//           {/* Action Indicators */}
//           {/* <div className="flex justify-center mt-6 md:mt-8 gap-8 md:gap-12">
//           <motion.div
...
//           >
//             <motion.div 
//               className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center shadow-lg mb-2"
//               whileHover={{ 
//                 scale: 1.2, 
//                 rotate: [0, 10, -10, 0],
...
//             </motion.div>
//             <motion.span 
//               className="text-xs md:text-sm text-slate-500 dark:text-slate-400 font-medium"
//               whileHover={{ 
//                 color: "#3b82f6",
//                 scale: 1.1
//               }}
...
//           >
//             <motion.div 
//               className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-success-400 to-success-600 flex items-center justify-center shadow-lg mb-2"
//               whileHover={{ 
//                 scale: 1.2, 
//                 rotate: [0, -10, 10, 0],
...
//           >
//             <motion.div 
//               className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-warning-400 to-warning-600 flex items-center justify-center shadow-lg mb-2"
//               whileHover={{ 
//                 scale: 1.2, 
//                 rotate: [0, 15, -15, 0],
...
//             {bookingSlots.slice(2, 5).map((slot) => (
//               <div
//                 key={`recent-${slot.id}`}
