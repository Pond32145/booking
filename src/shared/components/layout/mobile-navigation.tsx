...
export const MobileNavigation: React.FC = () => {
  ...
  const handleNavigation = (path: string) => {
    ...
    // If user is trying to access profile and is not authenticated, show login modal
  ...
  const navItems = [
    ...
    { path: '/profile', icon: isAuthenticated ? 'lucide:user' : 'lucide:log-in', label: isAuthenticated ? t.profile : 'เข้าสู่ระบบ' },
  ];
